...
**`Synthetic Data ScoreCard`** is an open-source Python toolbox that implements the **7C's approach** for assessing the quality of Synthetic Medical Data described in [Zamzmi et al. (2025)].
